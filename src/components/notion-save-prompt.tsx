...
export const NotionSavePrompt: React.FC<NotionSavePromptProps> = ({
  ...
  return (
    <Box flexDirection="column">
      <Text></Text>
      <Text color="blue" bold>Save Results to Notion?</Text>
      <Text></Text>
      <Text>
        You have {successCount} successfully graded {successCount === 1 ? 'repository' : 'repositories'}.
      </Text>
      <Text dimColor>
        Would you like to save these results to a Notion database?
      </Text>
      <Text></Text>
